...
<main class="container">
    ...
    <div class="row">
        <div class="col-lg-1">
            <section>
                <div class="fb-like" data-href="http://pro-level.hol.es/inicio.html" data-layout="button" data-action="like" data-show-faces="false" data-share="true"></div>
            </section>
        </div>
    </div> 
            <hgroup>
                ...
                <div id="tablatarjetas" class="col-md-6 col-sm-4">
                    ...
                    <table id="ttarjetas" class="table">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <aside>
                                <div class="fb-comments" data-href="http://localhost:8080/prolevel/paginas/jugador/vermisTorneos.jsp?idTorneo=30" data-numposts="10" data-colorscheme="light"></div>
                                </aside>
                            </div>
                        </div>     
</main>
